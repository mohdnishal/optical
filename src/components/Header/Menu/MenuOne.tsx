...
import logo from "../../../../public/images/optical/Al-Sharaf-Logo.png";
interface Props {
    props: string;
}
        ...
        <>
            ...
            >
                <div className="container mx-auto h-full">
                    <div className="w-full header-main flex  h-full">
                        <div
                        ...
                        <div className="lg:w-2/5 flex items-center gap-16">
                            <Link
                                href={"/"}
                        ...
                        <div className="lg:w-3/5 flex items-center gap-16">
